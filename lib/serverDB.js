...
const Transaction = new Schema(
  {
    ...
    addr: { type: String, lowercase: true, index: true },
    value: String,
    gas: Number,
    gasUsed: Number,
    gasPrice: String,
...
const mongocfg = process.cfg.mongodb

mongoose.connect(`mongodb://${mongocfg.user}:${mongocfg.pwd}@${mongocfg.host}:${mongocfg.port}/${mongocfg.dbname}`, {
